...
import { ShaderParams } from '../ne-logo/ne-logo.component';
import { NeLogoRainbowComponent } from '../ne-logo-rainbow/ne-logo-rainbow.component';

@Component({
  selector: 'app-header',
  standalone: true,
  imports: [CommonModule, MatButtonModule, NeLogoRainbowComponent],
